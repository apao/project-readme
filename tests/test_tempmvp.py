...
class _TestBaseBibliocommonsAvailabilitySearch(object):
    ...
    availability_search_cls = tempmvp.BaseBibliocommonsAvailabilitySearch
...
class TestSCCLLibraryAvailabilitySearch(_TestBaseBibliocommonsAvailabilitySearch):
    availability_search_cls = tempmvp.SCCLAvailabilitySearch
...
class TestSMCLLibraryAvailabilitySearch(_TestBaseBibliocommonsAvailabilitySearch):
    availability_search_cls = tempmvp.SMCLAvailabilitySearch
...
class TestSFPLLibraryAvailabilitySearch(_TestBaseBibliocommonsAvailabilitySearch):
    availability_search_cls = tempmvp.SFPLAvailabilitySearch
...
def test_whatever():
    searcher = tempmvp.SCCLAvailabilitySearch()
    serp_html = """<div class="col-sm-5 text_right_sm availability_block">
                        <span class="label availability">
                    <span role="presentation" class="item_available" testid="item_availability">Available </span>
                    <a href="/item/show_circulation/2639275093?search_scope=CAL-SFPL" class="circInfo value underlined" id="circ_info_trigger_2639275093_0.592804757729004" role="button" testid="availability_details">in some locations</a>
    ...
    result = searcher.populate_availability_by_avail_url(SCCL_AVAILABILITY_HTML, [])

    print result
#
# def test_smcl_availability():
#     searcher = tempmvp.SMCLAvailabilitySearch()
#
#     results = []
#     searcher.populate_availability_by_avail_url(SMCL_AVAILABILITY_HTML, results)


def test_sfpl_availability():
    searcher = tempmvp.SFPLAvailabilitySearch()

    results = []
    searcher.populate_availability_by_avail_url(SFPL_AVAILABILITY_HTML, results)
